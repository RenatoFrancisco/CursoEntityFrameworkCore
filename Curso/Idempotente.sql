...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210509213144_PrimeiraMigracao')
BEGIN
...
BEGIN
    CREATE TABLE [Pedidos] (
        ...
        [InciadoEm] datetime2 NOT NULL DEFAULT (GETDATE()),
...
BEGIN
    ...
    VALUES (N'20210509213144_PrimeiraMigracao', N'5.0.5');
END;
GO
